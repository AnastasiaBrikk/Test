...
### Решение:
1. Дадим пользователю самому ввести значения в массив, предварительно спросив о количестве вводимых им значений. Создаём метод заполнения массива количеством элементов, заданным пользователем.
